...
public abstract interface WeatherApiService {
    ...
    @org.jetbrains.annotations.Nullable()
    public abstract java.lang.Object getForcast(@retrofit2.http.Query(value = "q")
    @org.jetbrains.annotations.NotNull()
    java.lang.String cityName, @retrofit2.http.Query(value = "appid")
    @org.jetbrains.annotations.NotNull()
    java.lang.String apiKey, @retrofit2.http.Query(value = "units")
    ...
    @retrofit2.http.GET()
    @org.jetbrains.annotations.Nullable()
    public abstract java.lang.Object getCurrentWeatherByCorrdinates(@retrofit2.http.Query(value = "lat")
